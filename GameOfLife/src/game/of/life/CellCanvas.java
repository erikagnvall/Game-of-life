...
public class CellCanvas extends Canvas implements KeyListener, MouseListener, MouseMotionListener, Runnable {
	...
	/**
	 *  Cellerna som ett multidimensionell f�lt
	 */
	private Cell cells[][] = new Cell[nRows][nCols];

	/**
	 *  F�r- och bakgrundsf�rg
	 */
	...
	/**
	 * Sparad cellstatus f�r den cellen man klickade p�
	 */
	private boolean savedCellState = false;
	
	/**
	 * True om man ska k�ra programmet
	 */
	...
	/**
	 * Tr�den som programmet k�rs i och sleeptime
	 */
	Thread t;
	int sleep = 500;
	...
	/**
	 * Konstruktor f�r CellCanvas
	 * @param w integer med bredden
	 * @param h integer med h�jden
	 */
	 ...
	 * @param x x-kordinaten f�r cellen
	 * @param y y-kordinaten f�r cellen
	 */
	...
	/**
	 * H�mtar cellen p� det givna x- och y-v�rdet
	 * @param x x-kordinat att h�mta cell p�
	 * @param y y-kordinat att h�mta cell p�
	 * @return true eller false vid levande eller d�d
	 */
	...
	/**
	 * L�gger till en granne p� cellen f�r den givna kolumnen och raden
	 * @param c kolumnen p� cellen
	 * @param r raden p� cellen
	 */
	...
	/**
	 * GameOfLife-algoritmen f�r en levande cell
	 * @param c Cellen man ska kolla f�r
	 */
	...
	/**
	 * H�mtar den nuvarande sleeptimen
